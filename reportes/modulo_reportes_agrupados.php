          ...
          <div class="input-wrapper large-2 columns">
            ...
            <div class="input-wrapper large-2 columns">
              <select id="cmbGrupo" name="cmbGrupo" class="">
                  ...
                  <option value="1">Grafica por Generacion</option>
                  <option value="2">Graficas Generales</option>
                  <option value="3">Graficas de Formación</option>
                  <option value="4">Graficas de Trayectorias</option>
                  <option value="5">Graficas de Desempeño</option>
                  <option value="6">Graficas de Opinion</option>                  
              </select>
              <!--<small class="error">Campo requerido.</small>-->
            </div>       
